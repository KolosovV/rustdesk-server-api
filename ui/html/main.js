...
const I18N = {
    en: {
        appTitle: 'RustDesk Server',
        autoScroll: 'Turn on auto scroll',
        saveHint: 'Press ctrl + s to save',
        missingFile: 'file is missing'
    },
    ru: {
        appTitle: 'Сервер RustDesk',
        autoScroll: 'Включить автопрокрутку',
        saveHint: 'Нажмите Ctrl + S, чтобы сохранить',
...
function applyI18n(lang = 'en') {
    ...
    if (titleEl) document.title = dict[titleEl.getAttribute('data-i18n-title')] || document.title;
...
`;
                ...
                console.warn(`${this.file} ${dict.missingFile}`);
            }
        }
    }
    ...
    renderForm() {
        ...
        // Apply translations to ensure labels reflect current language
        applyI18n(this.lang);
        return form;
    }
    renderEditor() {
