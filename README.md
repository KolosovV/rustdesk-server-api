...
> Notes
>
> - The GUI currently supports only English and Russian languages (en/ru).
> - The panel/API base URL should use a path prefix: `http://<domain>:<port>/api`.
...
<p align="center">
  ...
  <!-- Language links removed; only English and Russian UI are supported in the app. -->
</p>
